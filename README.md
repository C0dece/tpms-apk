...
Реализовано через `BKReceiver` (уже было в оригинале).
...
└── screenshots/
    ├── screen.png                     ← Главный экран (EN)
    ├── screen_ru.png                  ← Главный экран (RU)
    └── settings_ru.png                ← Настройки (RU)
```
...
1. Проверьте совместимость версии Android
2. Убедитесь в корректной установке APK
3. Посмотрите логи через `adb logcat`
